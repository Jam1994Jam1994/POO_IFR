...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			// button1
			// 
			this->button1->Location = System::Drawing::Point(180, 102);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(92, 23);
			this->button1->TabIndex = 0;
			this->button1->Text = L"Afiseaza data";
			...
			this->button2->Text = L"Calculeaza";
			this->button2->UseVisualStyleBackColor = true;
			this->button2->Click += gcnew System::EventHandler(this, &Form1::button2_Click);
			// 
			// button3
			// 
			this->button3->Location = System::Drawing::Point(92, 102);
			...
			this->label1->Location = System::Drawing::Point(177, 40);
			...
			this->textBox1->Size = System::Drawing::Size(155, 86);
			this->textBox1->TabIndex = 4;
			// 
			// textBox2
			// 
			this->textBox2->Location = System::Drawing::Point(12, 131);
			this->textBox2->Multiline = true;
			this->textBox2->Name = L"textBox2";
			this->textBox2->Size = System::Drawing::Size(155, 98);
...
#pragma endregion
	...
	private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
		if (textBox1->Text->Length == 0) {
			...
			// afisare date in textbox2

			textBox2->Text = "data nasteri: " + zi.ToString() + "/" + luna.ToString() + "/" + an.ToString() + "\r\n" + "Varsta = " + varsta.ToString();
			//textBox2->Text = "\n" + varsta.ToString()
		}
	}
